...
class Booking extends Model
{
    ...
    public static function getCustomReturnIndexRecords($query, $parameters)
    {
        ...
        return $query
            ->select('id_225', 'status_text_225', 'date_225', 'date_text_225', 'check_in_date_225', 'check_in_date_text_225', 'object_name_225', 'customer_name_225', DB::raw('GROUP_CONCAT(id_226 SEPARATOR \', \') AS id_226'))
