...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/booking/bookings/{offset?}',                          ['as'=>'bookingBooking',                   'uses'=>'Syscover\Booking\Controllers\BookingController@index',                      'resource' => 'booking-booking',       'action' => 'access']);
    Route::any(config('pulsar.appName') . '/booking/bookings/json/data',                          ['as'=>'jsonDataBookingBooking',           'uses'=>'Syscover\Booking\Controllers\BookingController@jsonData',                   'resource' => 'booking-booking',       'action' => 'access']);
    Route::get(config('pulsar.appName') . '/booking/bookings/create/{offset}/{bulk?}',            ['as'=>'createBookingBooking',             'uses'=>'Syscover\Booking\Controllers\BookingController@createRecord',               'resource' => 'booking-booking',       'action' => 'create']);
    Route::post(config('pulsar.appName') . '/booking/bookings/store/{offset}',                    ['as'=>'storeBookingBooking',              'uses'=>'Syscover\Booking\Controllers\BookingController@storeRecord',                'resource' => 'booking-booking',       'action' => 'create']);
    Route::get(config('pulsar.appName') . '/booking/bookings/{id}/edit/{offset}',                 ['as'=>'editBookingBooking',               'uses'=>'Syscover\Booking\Controllers\BookingController@editRecord',                 'resource' => 'booking-booking',       'action' => 'access']);
    Route::put(config('pulsar.appName') . '/booking/bookings/update/{id}/{offset}',               ['as'=>'updateBookingBooking',             'uses'=>'Syscover\Booking\Controllers\BookingController@updateRecord',               'resource' => 'booking-booking',       'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/booking/bookings/delete/{id}/{offset}',               ['as'=>'deleteBookingBooking',             'uses'=>'Syscover\Booking\Controllers\BookingController@deleteRecord',               'resource' => 'booking-booking',       'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/booking/bookings/delete/select/records',           ['as'=>'deleteSelectBookingBooking',       'uses'=>'Syscover\Booking\Controllers\BookingController@deleteRecordsSelect',        'resource' => 'booking-booking',       'action' => 'delete']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/booking/bookings/draft/{offset?}',                          ['as'=>'bookingBookingDraft',                   'uses'=>'Syscover\Booking\Controllers\BookingDraftController@index',                      'resource' => 'booking-booking-draft',       'action' => 'access']);
    Route::any(config('pulsar.appName') . '/booking/bookings/draft/json/data',                          ['as'=>'jsonDataBookingBookingDraft',           'uses'=>'Syscover\Booking\Controllers\BookingDraftController@jsonData',                   'resource' => 'booking-booking-draft',       'action' => 'access']);
    Route::get(config('pulsar.appName') . '/booking/bookings/draft/create/{offset}/{bulk?}',            ['as'=>'createBookingBookingDraft',             'uses'=>'Syscover\Booking\Controllers\BookingDraftController@createRecord',               'resource' => 'booking-booking-draft',       'action' => 'create']);
    Route::post(config('pulsar.appName') . '/booking/bookings/draft/store/{offset}',                    ['as'=>'storeBookingBookingDraft',              'uses'=>'Syscover\Booking\Controllers\BookingDraftController@storeRecord',                'resource' => 'booking-booking-draft',       'action' => 'create']);
    Route::get(config('pulsar.appName') . '/booking/bookings/draft/{id}/edit/{offset}',                 ['as'=>'editBookingBookingDraft',               'uses'=>'Syscover\Booking\Controllers\BookingDraftController@editRecord',                 'resource' => 'booking-booking-draft',       'action' => 'access']);
    Route::put(config('pulsar.appName') . '/booking/bookings/draft/update/{id}/{offset}',               ['as'=>'updateBookingBookingDraft',             'uses'=>'Syscover\Booking\Controllers\BookingDraftController@updateRecord',               'resource' => 'booking-booking-draft',       'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/booking/bookings/draft/delete/{id}/{offset}',               ['as'=>'deleteBookingBookingDraft',             'uses'=>'Syscover\Booking\Controllers\BookingDraftController@deleteRecord',               'resource' => 'booking-booking-draft',       'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/booking/bookings/draft/delete/select/records',           ['as'=>'deleteSelectBookingBookingDraft',       'uses'=>'Syscover\Booking\Controllers\BookingDraftController@deleteRecordsSelect',        'resource' => 'booking-booking-draft',       'action' => 'delete']);
    ...
    */
    ...
    Route::post(config('pulsar.appName') . '/booking/vouchers/store/{offset}/{bulk?}',            ['as'=>'storeBookingVoucher',              'uses'=>'Syscover\Booking\Controllers\VoucherController@storeRecord',                'resource' => 'booking-voucher',       'action' => 'create']);
    ...
    Route::post(config('pulsar.appName') . '/booking/vouchers/get/data/objects/{model}',          ['as'=>'bookingGetDataObjects',            'uses'=>'Syscover\Booking\Controllers\VoucherController@getDataObjects',             'resource' => 'booking-voucher',       'action' => 'access']);
    Route::any(config('pulsar.appName') . '/booking/vouchers/export/csv',                         ['as'=>'exportCsvBookingVoucher',          'uses'=>'Syscover\Booking\Controllers\VoucherController@exportDataCsv',                  'resource' => 'booking-voucher',       'action' => 'access']);
