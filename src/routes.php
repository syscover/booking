...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.name') . '/booking/bookings/create/{offset}/{bulk?}',            ['as' => 'createBookingBooking',             'uses' => 'Syscover\Booking\Controllers\BookingController@createRecord',               'resource' => 'booking-booking',       'action' => 'create']);
    ...
    */
    ...
    Route::get(config('pulsar.name') . '/booking/bookings/draft/create/{offset}/{bulk?}',            ['as' => 'createBookingBookingDraft',             'uses' => 'Syscover\Booking\Controllers\BookingDraftController@createRecord',               'resource' => 'booking-booking-draft',       'action' => 'create']);
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.name') . '/booking/vouchers/{offset?}',                          ['as' => 'bookingVoucher',                              'uses' => 'Syscover\Booking\Controllers\VoucherController@index',                      'resource' => 'booking-voucher',       'action' => 'access']);
    Route::any(config('pulsar.name') . '/booking/vouchers/json/data',                          ['as' => 'jsonDataBookingVoucher',                      'uses' => 'Syscover\Booking\Controllers\VoucherController@jsonData',                   'resource' => 'booking-voucher',       'action' => 'access']);
    Route::get(config('pulsar.name') . '/booking/vouchers/create/{offset}/{bulk?}',            ['as' => 'createBookingVoucher',                        'uses' => 'Syscover\Booking\Controllers\VoucherController@createRecord',               'resource' => 'booking-voucher',       'action' => 'create']);
    Route::post(config('pulsar.name') . '/booking/vouchers/store/{offset}/{bulk?}',            ['as' => 'storeBookingVoucher',                         'uses' => 'Syscover\Booking\Controllers\VoucherController@storeRecord',                'resource' => 'booking-voucher',       'action' => 'create']);
    Route::get(config('pulsar.name') . '/booking/vouchers/{id}/edit/{offset}',                 ['as' => 'editBookingVoucher',                          'uses' => 'Syscover\Booking\Controllers\VoucherController@editRecord',                 'resource' => 'booking-voucher',       'action' => 'access']);
    Route::put(config('pulsar.name') . '/booking/vouchers/update/{id}/{offset}',               ['as' => 'updateBookingVoucher',                        'uses' => 'Syscover\Booking\Controllers\VoucherController@updateRecord',               'resource' => 'booking-voucher',       'action' => 'edit']);
    Route::get(config('pulsar.name') . '/booking/vouchers/delete/{id}/{offset}',               ['as' => 'deleteBookingVoucher',                        'uses' => 'Syscover\Booking\Controllers\VoucherController@deleteRecord',               'resource' => 'booking-voucher',       'action' => 'delete']);
    Route::delete(config('pulsar.name') . '/booking/vouchers/delete/select/records',           ['as' => 'deleteSelectBookingVoucher',                  'uses' => 'Syscover\Booking\Controllers\VoucherController@deleteRecordsSelect',        'resource' => 'booking-voucher',       'action' => 'delete']);
